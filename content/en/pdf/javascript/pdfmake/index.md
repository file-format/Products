...
<p>The library is stable and can be easily used on the client as well as server-side. It is runnable in the browser and in Node.js. It supports several popular browsers such as Internet Explorer 10+, Edge 12+, Firefox, Chrome, Opera, Safari, and so on.</p>
...
<div class="d1-logo" style="border: none;"><!--<img src='listing-image.png' alt="Compression APIs for .NET" />--><header>PDFMake</header><footer><small></small></footer></div>
<!--/logo--></div>
<!--/diagram1-->
{{< /SinglePage/PageBody/tab/diagram-carousel-item >}}
