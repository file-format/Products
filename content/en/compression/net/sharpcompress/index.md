...
<p>SharpCompress only requires <i class="fa fa-cubes">.NET Framework.</i></p>
<div class="diagram1 d1-poi">
<div class="d1-row">
<div class="d1-col d1-left"><header>.NET Standard 1.0</header><header>.NET Framework 3.5</header></div>
<!--/left-->
<div class="d1-col d1-right"> </div>
<!--/right--></div>
<!--/row-->
...
<h2 class="h2title">Getting Started with SharpCompress</h2>
<p>To install SharpCompress, you need to have .NET Framework 3.5 or above. You can manually download the repository from <a href="https://github.com/adamhathcock/sharpcompress">GitHub</a>. Or you can use NuGet.</p>
{{< /SinglePage/PageBody/features/text >}}

{{< SinglePage/PageBody/features/code >}}
<h3>Here is the command</h3>
<pre><code class="html"> Install-Package sharpcompress -Version number </code></pre>
...
{{< SinglePage/PageBody/features/text >}}
<h2 class="h2title">.NET Library to Compress and Extract Files from a ZIP File</h2>
<p>SharpCompress enables .NET developers to create a ZIP file by compressing the contents of a folder into a new <i>ZIP</i> file. The ZIP file format is one of the most widely used compression and archiving file formats. It helps to reduce the size of one or more files and also you can archive multiple files and folders into a single file. The API also enables developers to extract files from a ZIP file. You just need to point of out which file you want to extract, and it will cycle through e file in the archive to save it to a directory</p>
{{< /SinglePage/PageBody/features/text >}}

{{< SinglePage/PageBody/features/code >}}
<h3>Extract all File from RAR - C#</h3>
<pre><code class="c#">// Read RAR file
