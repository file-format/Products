...
description: LibVlcSharp - Play, Convert, Encode, Decode, & Manipulate Audio Files
...
<p>The best way to install LibVLCSharp is via NuGet. Run the following command and install LibVLCSharp in you application.</p>
{{< /SinglePage/PageBody/features/text >}}
